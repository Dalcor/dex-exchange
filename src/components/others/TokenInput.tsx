...
export default function TokenInput({setIsOpenedTokenPick}: {setIsOpenedTokenPick: (isOpened: boolean) => void}) {
  return <div className="px-5 py-4 bg-secondary-bg rounded-1 border border-primary-border">
