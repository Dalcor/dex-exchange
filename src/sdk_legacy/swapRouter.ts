...
//
// import { Currency } from "@/sdk_legacy/entities/currency";
// import { CurrencyAmount } from "@/sdk_legacy/entities/fractions/currencyAmount";
// import { Percent } from "@/sdk_legacy/entities/fractions/percent";
// import { Trade } from "@/sdk_legacy/entities/trade";
// import { MethodParameters, toHex } from "@/sdk_legacy/utils/calldata";
// import { encodeRouteToPath } from "@/sdk_legacy/utils/encodeRouteToPath";
// import { validateAndParseAddress } from "@/sdk_legacy/utils/validateAndParseAddress";
//
...
//     const mustRefund =
//       sampleTrade.inputAmount.currency.isNative && sampleTrade.tradeType === TradeType.EXACT_OUTPUT;
...
//       calldatas.push(
//         SelfPermit.encodePermit(sampleTrade.inputAmount.currency, options.inputTokenPermit),
//       );
//     }
//
...
//
//             calldatas.push(
//               SwapRouter.INTERFACE.encodeFunctionData("exactInput", [exactInputParams]),
//             );
//           } else {
...
//
//             calldatas.push(
//               SwapRouter.INTERFACE.encodeFunctionData("exactOutput", [exactOutputParams]),
//             );
//           }
//         }
//       }
...
//         if (outputIsNative) {
//           calldatas.push(
//             Payments.encodeUnwrapWETH9(totalAmountOut.quotient, recipient, options.fee),
//           );
//         } else {
//           calldatas.push(
