...
// import { NativeCurrency } from "@/sdk_legacy/entities/nativeCurrency";
// import { Pool } from "@/sdk_legacy/entities/pool";
// import { Position } from "@/sdk_legacy/entities/position";
// import { Token } from "@/sdk_legacy/entities/token";
...
//   JSBI.subtract(JSBI.exponentiate(JSBI.BigInt(2), JSBI.BigInt(128)), JSBI.BigInt(1)),
// );
//
...
//       [pool.token0.address, pool.token1.address, pool.fee, toHex(pool.sqrtRatioX96)],
//     );
//   }
//
