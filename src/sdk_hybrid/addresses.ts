...
export const CORE_AUTO_LISTING_ADDRESS: Record<DexChainId, Address> = {
  ...
  [DexChainId.BSC_TESTNET]: "0xB83b6a34802bb4149834110c28e3E0e270d804A8", // TODO: REPLACE
};

export const FREE_AUTO_LISTING_ADDRESS: Record<DexChainId, Address> = {
  [DexChainId.SEPOLIA]: "0xB83b6a34802bb4149834110c28e3E0e270d804A8", // TODO: REPLACE
  [DexChainId.BSC_TESTNET]: "0x6dd63E19D32B971cb979A94c51de26770a607c30", // TODO: REPLACE
};
