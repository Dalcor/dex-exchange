...
function PriceRangeCard() {
  return <div
    className="bg-secondary-bg border border-secondary-border rounded-1 p-5 flex justify-between items-center">
    <div className="flex flex-col gap-1">
      <span className="text-12 text-secondary-text">Low price</span>
      <input className="font-medium text-16 bg-transparent border-0 outline-0" type="text" value={906.56209}/>
  ...
  return <Container>
    <div className="w-[600px] bg-primary-bg mx-auto my-[80px]">
      ...
      <div className="rounded-b-2 border border-secondary-border border-t-0 p-10 bg-primary-bg">
        ...
        <div className="mb-5">
          <svg width="520" height="226" viewBox="0 0 520 226" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <rect opacity="0.1" x="113" width="288" height="202" fill="url(#paint0_linear_1983_51043)"/>
            <rect x="401" width="4" height="202" fill="#108E3D"/>
            <path d="M401 0H421C423.209 0 425 1.79086 425 4V44C425 46.2091 423.209 48 421 48H401V0Z" fill="#108E3D"/>
            ...
            <path d="M113 0H93C90.7909 0 89 1.79086 89 4V44C89 46.2091 90.7909 48 93 48H113V0Z" fill="#9576EC"/>
            ...
            <path
              ...
              fill="#B2B2B2"/>
            <defs>
              <linearGradient id="paint0_linear_1983_51043" x1="113" y1="119" x2="401" y2="119"
