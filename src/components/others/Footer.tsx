...
function FooterLink({ href, text }: { href: string, text: string }) {
  return <div><a target="_blank" href={href}
                 className="font-medium uppercase duration-200 hover:text-green">{text}</a></div>
}
...
export default function Footer() {
  return <footer className="border-t border-primary-border bg-black">
    <Container>
